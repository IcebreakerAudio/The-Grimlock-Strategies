...
This implementation is a direct copy/paste from Gin.
It seemed excessive to add the whole Gin library just for one file, so I have copied it here unchanged.
Only the necessary includes were added for integration into the project.

All credit and respect to the creator of Gin
...
namespace gin
{
    ...
    inline void applyStackBlur (juce::Image& img, int radius)
    {
